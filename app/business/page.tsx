...
export default function BusinessPage() {
  ...
  const businessItems: BusinessItem[] = [
    ...
    },
    {
      ...
      type: "competition",
      pinned: true,
      logo: "/competition/launchpadlogo.png",
   ...
   
    {
      ...
      title: "YuanQi Forest Universe Challenge",
      event: "YuanQi Forest",
      date: "2026.01",
      type: "marketing",
    ...
    },
    {
      ...
      title: "Roland Berger Campus Challenge",
      event: "Roland Berger",
      date: "2025.06",
      type: "competition",
    ...
    },
    {
      ...
      title: "Mengniu Campus Innovation Challenge",
      event: "Mengniu",
      date: "2025.12",
      type: "marketing",
