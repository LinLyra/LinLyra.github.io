...
export default function QBUS1040Page() {
  ...
  const reflection =
    "This unit connected maths to decisions. Optimisation plus regression became my go-to pair for structured business problems."
