...
export default function QBUS2810Page() {
  ...
  const meta = {
    ...
    tags: ["StatisticalModelling", "Forecasting", "Python"],
    notes: [] as string[]    
  }

  const outcomes = [
    { k: "Modelling principles", v: "Understand the core principles of statistical modelling for business-related variables." },
    { k: "Quantifying relationships", v: "Measure and analyse relationships between variables using a range of quantitative models and methods to support decisions." },
    { k: "Decision support", v: "Translate empirical relationships into actionable, data-informed business recommendations." },
    { k: "Data management", v: "Manage data pipelines and extract objective quantitative information for analysis." },
    { k: "Software proficiency", v: "Build competence using Python and related tools to analyse relationships and work with large datasets." },
    { k: "Communication", v: "Report empirical findings with appropriate statistical language, clear visualisations, and plain-English explanations for stakeholders." },
  ]
