...
export default function DATA3888Page() {
  ...
  const meta = {
    ...
    tagline:
      "A capstone project unit focused on building a public data product through interdisciplinary collaboration, computational analysis, and clear communication.",
    tags: ["Data Science", "Capstone", "Public Data Product"],
    notes: [] as string[],
  }
  ...
  const outcomes = [
    {
      k: "Problem framing",
      v: "Study an interdisciplinary data-driven problem and formulate it into an analytical framework.",
    },
    {
      k: "Interdisciplinary application",
      v: "Apply disciplinary knowledge to solve problems in an interdisciplinary context.",
    },
    {
      k: "Investigation strategy",
      v: "Create an investigation strategy, explore solutions, discuss approaches, and predict outcomes.",
    },
    {
      k: "Digital analysis",
      v: "Analyse data using modern information technology and digital skills.",
    },
    {
      k: "Resilience and integrity",
      v: "Demonstrate integrity, confidence, personal resilience, and the capacity to manage challenges individually and in teams.",
    },
    {
      k: "Collaboration",
      v: "Collaborate with diverse groups and across cultural boundaries to develop solutions to project problems.",
    },
    {
      k: "Communication",
      v: "Communicate project outcomes effectively to an interdisciplinary audience.",
    },
  ]
