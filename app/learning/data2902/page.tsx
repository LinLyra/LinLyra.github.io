...
export default function DATA2902Page() {
  ...
  const outcomes = [
    { k: "Problem formulation", v: "Frame domain-specific questions and select appropriate statistical analyses." },
    { k: "Data acquisition & integration", v: "Extract, join, and harmonise data from multiple sources." },
    { k: "Summarisation & EDA", v: "Build numerical and graphical summaries for varied—and large/complex—datasets." },
    { k: "Version control", v: "Use a software version-control system (e.g., Git) effectively in analytics workflows." },
    { k: "Statistical inference", v: "Choose, justify, and implement suitable parametric or non-parametric tests." },
    { k: "Linear modelling", v: "Formulate, fit, and interpret linear models for multi-factor relationships." },
    { k: "Statistical ML", v: "Apply a given classifier, design cross-validation, and report predictive accuracy." },
    { k: "Reproducible reporting", v: "Produce reproducible reports (R Markdown/Quarto) that communicate results clearly to stakeholders." }
  ]
