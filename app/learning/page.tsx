...
type LearningStatus = "completed" | "in-progress" | "planned"
type LearningType = "degree" | "course" | "online-course"
  ...
  const items: LearningItem[] = [
    {
      ...
      tags: ["Python", "Regression", "Visualization", "EDA", "Statistics", "Dashboards", "Storytelling"],
      status: "completed",
    },
    {
    ...
    },
    {
      ...
      tags: ["Forecasting", "Time Series", "Python", "Classification", "Model Evaluation", "Feature Engineering", "CV"],
      status: "in-progress",
      level: "undergrad",
      audited: true,
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Optimisation", "Management Science", "Decision Analysis", "Stochastic Models", "Simulation", "Integer Programming", "Applications"],
      status: "in-progress",
      level: "undergrad",
    },
    {
      slug: "data3404",
      title: "DATA3404: Scalable Data Management",
      institution: "University of Sydney",
      date: "2026 S1",
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Big Data", "Database Systems", "Distributed Data", "Query Optimisation", "Indexing", "Spark", "Performance"],
      status: "in-progress",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Data Science", "Capstone", "Public Data Product", "Teamwork", "Communication", "Stakeholders", "Delivery"],
      status: "in-progress",
      level: "undergrad",
    },
    {
      ...
      type: "online-course",
      logo: "/learning/googlelogo.png",
      tags: ["GenAI", "Vertex AI", "GKE", "Data Engineering", "LLMs", "MLOps"],
      status: "completed",
    },
  
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Statistical Modeling", "Forecasting", "Python", "GLM", "Model Selection", "Diagnostics", "Business Data"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["R", "Statistical ML", "Quarto", "RMarkdown", "Feature Engineering", "Model Evaluation", "Reproducibility"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["LP/IP/NLP", "Optimisation", "Excel Solver", "Python", "Sensitivity", "Constraints", "Decision Support"],
      status: "in-progress",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Decision Analysis", "Decision Trees", "Sensitivity", "Risk Assessment", "Expected Utility", "Value of Info", "Uncertainty", "Managerial Decisions"],
      status: "in-progress",
      level: "undergrad",
    },

    {
      ...
      type: "course",
      logo: "/learning/usydlogo.png",
      tags: ["Database Design", "SQL", "Normalization", "Transaction Mgmt", "OLAP", "Indexing", "ER Modeling"],
      status: "in-progress",
      level: "undergrad",
      audited: true,
    },
    {
      ...
      type: "course",
      logo: "/learning/usydlogo.png",
      tags: ["SQL", "MongoDB", "Neo4j", "Distributed Systems", "Query Tuning", "Indexing", "Data Modeling"],
      status: "completed",
      level: "postgrad",
      audited: true,
    },
    {
      ...
      type: "course",
      logo: "/learning/usydlogo.png",
      tags: ["Deep Learning", "Data Mining", "Python", "Clustering", "Classification", "Feature Eng", "Evaluation"],
      status: "completed",
      level: "postgrad",
      audited: true,
    },
    {
      ...
      type: "course",
      logo: "/learning/usydlogo.png",
      tags: ["Deep Learning", "Model Evaluation", "PyTorch", "TensorFlow", "Regularization", "Generalization", "Optimization"],
      status: "completed",
      level: "postgrad",
      audited: true,
    },
    {
      ...
      tags: ["ARIMA", "Stationarity", "Forecasting", "R", "Python", "ACF/PACF", "Model Diagnostics"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/sjtulogo.png",
      tags: ["Poisson", "CTMC/DTMC", "Queueing", "Markov Chains", "Martingales", "Birth–Death", "Simulation"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Algorithm", "Sorting", "Graph", "Tree", "Complexity", "Data Structures", "DP"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Search", "ML", "Game AI", "Planning", "Reasoning", "Python", "Heuristics"],
      status: "completed",
      level: "undergrad",
    },
    {
    ...
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Python", "Pipelines", "ML Basics", "Visualization", "Data Wrangling", "Git", "APIs"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "online-course",
      logo: "/learning/googlelogo.png",
      tags: ["Prompting", "Embeddings/RAG", "Agents", "MLOps", "LLMs", "Evaluation", "Deployment"],
      status: "completed",
    },
   
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["R", "Statistics", "Hypothesis Testing", "Visualization", "Tidyverse", "EDA", "Reporting"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Calculus", "Linear Algebra", "Proof", "Derivatives", "Integrals", "Vectors", "Series"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Multivariable", "Differential Eqns", "R", "Gradients", "Optimization", "Linear Systems", "Taylor"],
      status: "completed",
      level: "undergrad",
    },
    {
      ...
      type: "degree",
      logo: "/learning/usydlogo.png",
      tags: ["Python", "OOP", "Shell Scripting", "Testing", "Debugging", "Data Structures", "CLI"],
      status: "completed",
      level: "undergrad",
    }, 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8 space-y-4">
            <div className="relative mx-auto max-w-xl">
              <Input
                placeholder="Search by course, institution, skill…"
                value={q}
