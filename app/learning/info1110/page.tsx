...
export default function INFO1110Page() {
  ...
  const learningOutcomes = [
    ...
    { k: "Array & Recursion Patterns", v: "Implemented array patterns (min/max, sum, search) and recursive functions for numerical/array tasks." },
    { k: "Testing & Debugging", v: "Practised systematic testing and debugging; wrote test cases and used standard libraries effectively." },
