...
export default function STAT2011Page() {
  ...
  const meta = {
    ...
    tagline:
      "Constructed probabilistic models and built estimators with quantified uncertainty for real-world data.",
    tags: ["Probability", "Estimation", "Asymptotics", "R/Python"],
    notes: [] as string[],
  }

  const outcomes = [
    { k: "Statistical Modelling", v: "Built probability models with random variables; computed expectations, variances, probabilities." },
    { k: "Parameter Estimation", v: "Estimated parameters and quantified uncertainty (theoretical & computational)." },
    { k: "Model Evaluation", v: "Checked fit and assessed accuracy with standard tools." },
    { k: "Theoretical Reasoning", v: "Applied/proved key results relevant to estimation and asymptotics." },
  ]

  const reflection = `This unit gave me the language to talk about uncertainty precisely—and to argue about it responsibly.`
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {hasNotes && <MediaModel isOpen={showNotes} onClose={() => setShowNotes(false)} title={meta.title} media={{ images
