...
export default function COMP2123Page() {
  ...
  const reflection = `This unit made me deliberate about data representation first, code second. Thinking in
invariants and costs now anchors my everyday implementation choices.`
