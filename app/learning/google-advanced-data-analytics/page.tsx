...
export default function GooglePage() {
  ...
  const meta = {
   ...
   const outcomes = [
    { k: "Role & practice", v: "Understood the roles of data professionals in organizations and the kinds of problems they solve."},
    { k: "Exploratory analysis & visualization", v: "Created exploratory visualizations and applied statistical methods to investigate data." },
    { k: "Modeling", v: "Built and interpreted regression and machine-learning models for analysis and prediction." },
    { k: "Communication", v: "Communicated insights through clear narratives and dashboards tailored to stakeholders." },
    { k: "Hands-on tooling", v: "Gained practical experience using Python in Jupyter Notebook and Tableau for end-to-end workflows." },
  ]
