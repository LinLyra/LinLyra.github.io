...
export default function COMP5318Page() {
  ...
  const outcomes = [
    { k: "Algorithm principles & scope", v: "Understand core concepts, strengths/weaknesses, and applicability of ML methods for **classification, regression, clustering, and reinforcement learning tasks." },
    { k: "Hands-on design & evaluation", v: "Gain practical experience **designing, implementing, and evaluating** ML algorithms with appropriate metrics, validation, and baselines." },
    { k: "Software proficiency", v: "Use modern ML libraries and workflows (e.g., scikit-learn pipelines, model selection, visual analytics) to build reproducible analyses." },
