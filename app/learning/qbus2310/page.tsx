...
export default function QBUS2310Page() {
  ...
  const outcomes = [
    { k: "Model selection", v: "Choose among LP, IP, NLP, and goal-programming models according to the business context and objectives." },
    { k: "Formulation", v: "Translate real-world problems into well-posed optimisation models—objective functions, constraints, and decision variables." },
    { k: "Model critique", v: "Identify assumptions and limitations; propose remedies such as alternative formulations, sensitivity/what-if analysis, or robust approaches." },
    { k: "Decision making", v: "Interpret optimisation outputs (solutions, trade-offs, sensitivities) to make sound managerial recommendations." },
